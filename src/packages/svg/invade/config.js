...
import StartStopProgress from './component/start-stop-progress.vue'
import RingBlock from './component/ring/index.vue'
import DragramBlock from './component/ring/dragram.vue'
// 色值
const colorArr1 = [
  '#8A6BD6',
  '#8776D6',
...
const list = [
  ...
  {
    label: 'start-stop-loading',
    type: 'start-stop-loading',
    component: 'StartStopProgress',
    width: 400,
    height: 400,
    color: '#4886cd',
    radius: 100,
