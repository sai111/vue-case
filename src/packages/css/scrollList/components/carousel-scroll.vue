...
<script>
// 来源：https://github.com/chenxuan0000/vue-seamless-scroll
// import { animationFrame } from '@/lib/utils/animationFrame.js'
import _obj from '@/lib/utils/copyObj.js'
import _array from '@/lib/utils/array.js'
export default {
  name: 'CarouselScroll',
  components: {},
  props: {
  ...
  computed: {
    ...
    options () {
      return _obj.copyObj(this.defaultOption, this.classOption)
    },
    navigation () {
  ...
  watch: {
    data (newData, oldData) {
      ...
      //监听data是否有变更
      if (!_array.arrayEqual(newData, oldData)) {
        this.reset()
      }
    },
    autoPlay (bol) {
